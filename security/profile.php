...
// Get the details of the security personnel
$getStudent = "Select * from security WHERE indexnumber=:indexnumber LIMIT 1";
...
if (isset($_POST['submit'])) {
    ...
    if (count($errors) === 0) {
        ...
        $SQL = "UPDATE security SET name=:name,contact=:contact WHERE indexnumber=:indexnumber";
